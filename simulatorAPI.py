...
import random
seed_number = 1978 # (blue, bricks, tunnel 2 x middle!) #6505 (red, hill) #1234 (red, bricks)
...
class World(object):
    ...
    def move(self, sim_time, res=1):
        ...
        for index in range(res, len(way_points), res):
            ...
            start.location.z = _road_height
            end.location.z = _road_height
            self.world.debug.draw_line(start.location, end.location, 0.1, carla.Color(r=125, g=0, b=0), .1)
            previous_index = index
